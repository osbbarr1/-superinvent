...
public class UsuarioDetailServices implements UserDetailsService  {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		UsuariosEntity user = (UsuariosEntity) usuarioDao.findByUsername(username);
...
//		}
		...
		// rol);
		return new User(user.getUsuarionombre(), user.getUsuariopass(), true, true, true, true, rol);
